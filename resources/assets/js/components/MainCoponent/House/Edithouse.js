...
class Addhouse extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(this.props.base_url + 'api/edit-house/' + house_id)
            .then(response => {
                if (response.data) {
                    this.setState({
                        ...
                        house_information: response.data.house_information
                    })
                }
            })
    }
    ...
    handleOnSubmit(e) {
        ...
        Axios.post(this.props.base_url + 'api/update-house-info', data)
            .then(response => {
                if (response.data) {
    ...
    render() {
        return (
            ...
            <div className="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
                <h4 className="tx-gray-800 mg-b-5">Edit House</h4>
            </div>
