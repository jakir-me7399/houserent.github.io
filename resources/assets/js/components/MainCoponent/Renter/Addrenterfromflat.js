...
class Addrenterfromflat extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        Axios.get(this.props.base_url + 'api/renter-house-id/' + flat_id)
            .then(response => {
                if (response.data) {
                    this.setState({
                    ...
                    <form onSubmit={(e) => this.handleOnSubmit(e)} className="br-section-wrapper" data-parsley-validate>
                        <div className="form-layout form-layout-5">
                            ...
                            <div className="row mg-t-20">
                                ...
                                <div className="col-sm-9 mg-t-10 mg-sm-t-0">
                                    <select name="flat_id" onChange={(e) => this.handleInput(e)} readOnly className="form-control">
...
export default connect(mapStateToProps, null)(Addrenterfromflat);